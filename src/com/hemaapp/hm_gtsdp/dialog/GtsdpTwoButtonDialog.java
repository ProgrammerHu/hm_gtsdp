...
public class GtsdpTwoButtonDialog extends XtomObject {
	...
	public GtsdpTwoButtonDialog(Context context) {
		...
		leftButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (buttonListener != null)
					buttonListener.onLeftButtonClick(GtsdpTwoButtonDialog.this);
			}
		});
		...
		rightButton.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				if (buttonListener != null)
					buttonListener.onRightButtonClick(GtsdpTwoButtonDialog.this);
			}
		});
