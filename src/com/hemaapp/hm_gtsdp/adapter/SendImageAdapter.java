...
import com.hemaapp.hm_gtsdp.activity.SendDetailActivty;

/**
 * ·¢ËÍµÄÍ¼Æ¬
 */
public class SendImageAdapter extends GtsdpAdapter implements OnClickListener {
	...
	private void setDataImage(int position, ViewHolder holder) {
		...
		GtsdpActivity activity = (GtsdpActivity) mContext;
		XtomImageTask imageTask = new XtomImageTask(holder.imageView, path,
				mContext, new Size(70, 70));
	...
	public void onClick(View v) {
		switch (v.getId()) {
		case R.id.button:
			SendDetailActivty activity = (SendDetailActivty) mContext;
