 ...
 * 自定义下拉刷新(上拉加载)布局
 */
public class GtsdpRefreshLoadmoreLayout extends XtomRefreshLoadmoreLayout {
	private boolean isLoading;
	private boolean isRefreshing;
	public GtsdpRefreshLoadmoreLayout(Context context) {
		this(context, null);
	}

	public GtsdpRefreshLoadmoreLayout(Context context, AttributeSet attrs) {
		super(context, attrs);
		init();
	}
